...
test('manual voucher backfill exposes opt-in XML diagnostics', () => {
    const help = childProcess.execFileSync(process.execPath, ['dist/cli.mjs', 'voucher-orders', '--help'], { encoding: 'utf8' });
    assert.match(help, /--debug-xml/);
